...
|---|---|---|--|----|----|----|----|----|--|------|-------|--------------|------------------|
|   |ลำดับ|SKU|ชื่อ|ขนาด|LOT1|LOT2|LOT3|LOT4|OH|OHTime|LotTime|Favorite(bool)|FavTime(timestamp)|

- Row 1: Title (`Stock Manager — {SheetName}`)
- Row 2: Headers
- Row 3+: Data
- Col M สร้างอัตโนมัติครั้งแรกที่กด Favorite
...
state = {
  ...
  subTab:      'All',    // subtab ('All' | 'Favorite' | sheetName)
...
- **Column M**: สร้างอัตโนมัติ (`insertColumnsAfter`) ตอนกด Favorite ครั้งแรก
